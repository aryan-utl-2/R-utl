...
#  tags$head(tags$link(rel = "stylesheet", type = "text/css", href = "grid.css")),
  ...
  tabItems(
    tabItem(tabName = "landingpage",
            boxPlus(width = 12, class = "display_window my_style_1",
    ...
    tabItem(tabName = "analytics",
            boxPlus(width = 12, class = "display_window window_format", 
                    fluidRow(
    ...
    tabItem(tabName = "dashboard",
            boxPlus(width = 12, class = "display_window window_format",
                    ...
                    fluidRow(column(width = 8, style = "margin:0;padding:0;",
                                    div(class = "header_label2",h1("Welcome to your Free Trial"),h3("We are here to help make education and career planning easier.")
                                        )),
                             column(width = 4,
            ...
            boxPlus(width = 12, class = "display_window window_format", 
                   column(width = 2,style = "padding:0px;margin:0px;margin-top:2em;",
                      ...
                      style = "background-color:white;padding-left: 5px;padding-right: 5px;margin-left:0px;",
                        selectInput(inputId = "es_school", label = "School", choices = c("All" = '',school_master$INSTNM), width = "95%"),
